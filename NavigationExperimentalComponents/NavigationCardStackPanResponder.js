  ...
  onMoveShouldSetPanResponder(event: any, gesture: any): boolean {
    ...
    const positionMax = isVertical
      ...
      */
      ...
      if (isVertical) {
        return index !== 0 && currentDragPosition < 120 && Math.abs(currentDragDistance) > RESPOND_THRESHOLD;
      } else {
      ...
      return Math.abs(currentDragDistance) > (RESPOND_THRESHOLD + isVertical ? 15 : 0) && maxDragDistance > 0 && index > 0;
  }
